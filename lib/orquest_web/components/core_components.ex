defmodule OrquestWeb.CoreComponents do
  @moduledoc """
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-border/10 ring-border/10 relative hidden rounded-2xl bg-card p-14 shadow-lg ring-1 transition"
            >
  ...
  def flash(assigns) do
    ...
    <div
      ...
      class={[
        ...
        @kind == :info && "bg-primary/15 text-primary ring-primary fill-primary",
        @kind == :error && "bg-destructive/15 text-destructive shadow-md ring-destructive fill-destructive"
      ]}
      {@rest}
    >
    ...
    <div>
      <label class="flex items-center gap-4 text-sm leading-6 text-muted-foreground">
        ...
        <input
          ...
          value="true"
          checked={@checked}
          class="rounded border-input text-foreground focus:ring-0"
          {@rest}
        />
        {@label}
      </label>
  ...
  def input(%{type: "select"} = assigns) do
    ...
    <div>
      ...
      <select
        id={@id}
        name={@name}
        class="mt-2 block w-full rounded-md border border-input bg-card shadow-sm focus:border-primary focus:ring-0 sm:text-sm"
        multiple={@multiple}
        {@rest}
      >
    ...
    <div>
      ...
      <textarea
        ...
        class={[
          ...
          @errors == [] && "border-input focus:border-primary",
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(OrquestWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(OrquestWeb.Gettext, "errors", msg, opts)
    # end
